...
namespace EasyUI.PickerWheelUI {
   ...
   public class PickerWheel : MonoBehaviour {
      ...
      [Space]
      [Header("Configuraciones de la ruleta seleccionadora:")]
      [Range (1, 20)] public int spinDuration = 8 ;
      [SerializeField] [Range (.2f, 2f)] private float wheelSize = 1f ;

      [Space]
      [Header("Piezas de la ruleta seleccionadora:")]
      ...
      private void Start () {
         ...
         if (nonZeroChancesIndices.Count == 0)
            Debug.LogError ("No puedes establecer la probabilidad de todas las piezas en cero.") ;
      ...
      private void OnValidate () {
         ...
         if (wheelPieces.Length > piecesMax || wheelPieces.Length < piecesMin)
            Debug.LogError("[PickerWheelwheel] La longitud de las piezas debe estar entre " + piecesMin + " y " + piecesMax);
      }
   }
}